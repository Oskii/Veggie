...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 PIXI from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 PIXI in block rewards plus fees, but
        ...
        # Send 10 PIXI with subtract fee from amount
        ...
        # Sendmany 10 PIXI with subtract fee from amount
