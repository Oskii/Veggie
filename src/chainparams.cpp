...
{
    const char* pszTimestamp = "Forbes 27/10/2017 Red Hot Blockchain Tech Expands Application In Gaming Industry";
...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("45.32.138.152", "45.76.140.199"));
