...
int main(int argc, char *argv[])
{
    ...
    {
        QMessageBox::critical(0, QObject::tr(VEGGIE_PACKAGE_NAME),
    ...
    try {
        ...
        QMessageBox::critical(0, QObject::tr(VEGGIE_PACKAGE_NAME), QObject::tr("Error: %1").arg(e.what()));
        return EXIT_FAILURE;
    }
#ifdef ENABLE_WALLET
    ...
    try
    {
        ...
        WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("%1 didn't yet exit safely...").arg(QObject::tr(VEGGIE_PACKAGE_NAME)), (HWND)app.getMainWinId());
#endif
        app.exec();
        app.requestShutdown();
        app.exec();
